...
if ( isset($_POST["username"])) {
    ...
    $_SESSION["added_sessions"] = 0;
    $_SESSION["deleted_sessions"] = 0;
}
...
if (!isset($_SESSION["username"])) {
    ...
    <p>You have added <?php echo $_SESSION["added_sessions"]; ?> records</p>
    <p>you have deleted <?php echo $_SESSION["deleted_sessions"]; ?> records</p>
    <?php
}
?>
